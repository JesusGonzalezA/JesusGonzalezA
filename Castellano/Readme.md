...
[See my CV here!](CV_Es.pdf) Hey, soy Jesús, estudiante de ingeniería informática (ingeniería del software) en la UGR (Universidad de Granada, España). 
...
:fire: **Me siento cómodo utilizando:** 

![React](https://img.shields.io/badge/-React-61DAFB?logo=react&logoColor=white)
![JavaScript](https://img.shields.io/badge/-JavaScript-F7DF1E?logo=JavaScript&logoColor=black)
![C++](https://img.shields.io/badge/-C++-00599C?&logo=cplusplus?logoColor=black)

:mortar_board: **He usado recientemente:**


:two_men_holding_hands: Metodologías de desarrollo ágiles \
Scrum


:hammer: Desarrollo web \
...
:clipboard: **Interesado pero aún no he usado:** 
